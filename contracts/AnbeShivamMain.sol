...
contract AnbeShivamMain is Ownable {
    ...
    function investFunds(uint _contentID, string memory _metadata) external payable {
        ...
        IAnbeShivamInvestorToken(GODSContract).mint(msg.sender, msg.value);
        IAnbeShivamNFT(NFTContract).safeMint(msg.sender, _metadata);
